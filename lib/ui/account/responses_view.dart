                        ...
                        children: [
                          Row(
                            children: [
                              ...
                              const SizedBox(width: 5),
                              Expanded(child: Text('${response.responseID} от ${response.updated}', style: darkCategory(18, FontWeight.normal), overflow: TextOverflow.clip,)),
                            ],
                          ),
                          ...
                          Row(
                            children: [
                              ...
                              const SizedBox(width: 5),
                              Expanded(child: Text('${response.requestID} от ${response.created}', style: darkCategory(14, FontWeight.normal), overflow: TextOverflow.clip,)),
                            ],
                          ),
                          const SizedBox(height: 5),
                          Row(
                            children: [
                              ...
                              const SizedBox(width: 5),
                              Text(response.shipAddress, style: darkProduct(16, FontWeight.normal), overflow: TextOverflow.clip,),
                            ],
                          ),
                          const SizedBox(height: 5,),
                          Text('товаров: ${response.products}', style: darkProduct(16, FontWeight.normal), overflow: TextOverflow.clip,),
                          Text('сумма: ${response.total}₽', style: darkProduct(16, FontWeight.w500), overflow: TextOverflow.clip,),
                        ],
                      ),
                    ),
                  ),
