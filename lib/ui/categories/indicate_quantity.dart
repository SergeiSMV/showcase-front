...
indicateQuantity(BuildContext mainContext, TextEditingController controller, String name){
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: Align(alignment: Alignment.centerLeft, child: Text(name, style: darkCategory(18, FontWeight.bold),)),
            ),
            Padding(
